    ...
    <div class="container">
      ...
      <?php
        ...
        while($data = mysqli_fetch_assoc($result)){ 
          ...
          echo "<td>$data[gpa]</td>";
          echo "<td><a href='student_edit.php?nim={$data['nim']}'>Edit</a> | <a href='student_delete.php?nim={$data['nim']}' onclick=\"return confirm('Apakah Anda yakin akan menghapus data ini?')\">Hapus</a></td>";
          echo "</tr>";
        }
